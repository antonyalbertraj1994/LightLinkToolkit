...
class AnalogSensor (private val activity: Activity, private val brightness:Int, private val onSensorUpdate: (String) -> Unit ) {
    ...
    fun start_calibration(maxlux:Double) {
        ...
        val calibration_current = 6.0 // 6 for temperature sensor, 100 for microcontroller
